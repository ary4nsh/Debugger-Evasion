...
if not defined VCVARS (
    ...
    echo   cl /EHsc /Fe:"Stack Segment Register.exe" "Stack Segment Register.cpp"
    exit /b 1
)

call "%VCVARS%" >nul 2>&1

cl /nologo /EHsc /Fe:"Stack Segment Register.exe" "Stack Segment Register.cpp"
if errorlevel 1 exit /b 1

echo.
echo Built: %DIR%Stack Segment Register.exe
exit /b 0
