...
if not defined VCVARS (
    ...
    echo   cl /EHsc /Fe:"POPF and Trap Flag.exe" "POPF and Trap Flag.cpp"
    exit /b 1
)

call "%VCVARS%" >nul 2>&1

cl /nologo /EHsc /Fe:"POPF and Trap Flag.exe" "POPF and Trap Flag.cpp"
if errorlevel 1 exit /b 1

echo.
echo Built: %DIR%POPF and Trap Flag.exe
exit /b 0
