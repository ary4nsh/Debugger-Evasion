...
if not defined VCVARS (
    ...
    echo   cl /EHsc /Fe:"Instrucion Prefixes.exe" "Instrucion Prefixes.cpp"
    exit /b 1
)

call "%VCVARS%" >nul 2>&1

cl /nologo /EHsc /Fe:"Instrucion Prefixes.exe" "Instrucion Prefixes.cpp"
if errorlevel 1 exit /b 1

echo.
echo Built: %DIR%Instrucion Prefixes.exe
exit /b 0
