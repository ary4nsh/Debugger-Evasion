...
if not defined VCVARS (
    ...
    echo   cl /EHsc /Fe:RtlQueryProcessHeapInformation.exe RtlQueryProcessHeapInformation.cpp
    exit /b 1
)

call "%VCVARS%" >nul 2>&1

cl /nologo /EHsc /Fe:RtlQueryProcessHeapInformation.exe RtlQueryProcessHeapInformation.cpp
if errorlevel 1 exit /b 1

echo.
echo Built: %DIR%RtlQueryProcessHeapInformation.exe
exit /b 0
