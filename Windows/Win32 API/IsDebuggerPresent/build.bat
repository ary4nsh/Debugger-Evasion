...
if not defined VCVARS (
    ...
    echo   cl /EHsc /Fe:IsDebuggerPresent.exe IsDebuggerPresent.cpp
    exit /b 1
)

call "%VCVARS%" >nul 2>&1

cl /nologo /EHsc /Fe:IsDebuggerPresent.exe IsDebuggerPresent.cpp
if errorlevel 1 exit /b 1

echo.
echo Built: %DIR%IsDebuggerPresent.exe
exit /b 0
