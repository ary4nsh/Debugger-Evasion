...
if not defined VCVARS (
    ...
    echo   cl /EHsc /Fe:ProcessDebugObjectHandle.exe ProcessDebugObjectHandle.cpp
    exit /b 1
)

call "%VCVARS%" >nul 2>&1

cl /nologo /EHsc /Fe:ProcessDebugObjectHandle.exe ProcessDebugObjectHandle.cpp
if errorlevel 1 exit /b 1

echo.
echo Built: %DIR%ProcessDebugObjectHandle.exe
exit /b 0
