...
if not defined VCVARS (
    ...
    echo   cl /EHsc /Fe:ProcessDebugPort.exe ProcessDebugPort.cpp
    exit /b 1
)

call "%VCVARS%" >nul 2>&1

cl /nologo /EHsc /Fe:ProcessDebugPort.exe ProcessDebugPort.cpp
if errorlevel 1 exit /b 1

echo.
echo Built: %DIR%ProcessDebugPort.exe
exit /b 0
