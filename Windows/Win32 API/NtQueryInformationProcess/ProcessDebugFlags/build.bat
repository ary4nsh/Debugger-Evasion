...
if not defined VCVARS (
    ...
    echo   cl /EHsc /Fe:ProcessDebugFlags.exe ProcessDebugFlags.cpp
    exit /b 1
)

call "%VCVARS%" >nul 2>&1

cl /nologo /EHsc /Fe:ProcessDebugFlags.exe ProcessDebugFlags.cpp
if errorlevel 1 exit /b 1

echo.
echo Built: %DIR%ProcessDebugFlags.exe
exit /b 0
