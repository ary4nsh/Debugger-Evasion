...
if not defined VCVARS (
    ...
    echo   cl /EHsc /Fe:NtQuerySystemInformation.exe NtQuerySystemInformation.cpp
    exit /b 1
)

call "%VCVARS%" >nul 2>&1

cl /nologo /EHsc /Fe:NtQuerySystemInformation.exe NtQuerySystemInformation.cpp
if errorlevel 1 exit /b 1

echo.
echo Built: %DIR%NtQuerySystemInformation.exe
exit /b 0
