...
if not defined VCVARS (
    ...
    echo   cl /EHsc /Fe:CheckRemoteDebuggerPresent.exe CheckRemoteDebuggerPresent.cpp
    exit /b 1
)

call "%VCVARS%" >nul 2>&1

cl /nologo /EHsc /Fe:CheckRemoteDebuggerPresent.exe CheckRemoteDebuggerPresent.cpp
if errorlevel 1 exit /b 1

echo.
echo Built: %DIR%CheckRemoteDebuggerPresent.exe
exit /b 0
