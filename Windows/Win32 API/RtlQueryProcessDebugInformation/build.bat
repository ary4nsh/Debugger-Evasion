...
if not defined VCVARS (
    ...
    echo   cl /EHsc /Fe:RtlQueryProcessDebugInformation.exe RtlQueryProcessDebugInformation.cpp
    exit /b 1
)

call "%VCVARS%" >nul 2>&1

cl /nologo /EHsc /Fe:RtlQueryProcessDebugInformation.exe RtlQueryProcessDebugInformation.cpp
if errorlevel 1 exit /b 1

echo.
echo Built: %DIR%RtlQueryProcessDebugInformation.exe
exit /b 0
