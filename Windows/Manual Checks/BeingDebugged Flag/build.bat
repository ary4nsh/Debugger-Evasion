...
if not defined VCVARS (
    ...
    echo   cl /EHsc /Fe:BeingDebugged-flag.exe BeingDebugged-flag.cpp
    exit /b 1
)

call "%VCVARS%" >nul 2>&1

cl /nologo /EHsc /Fe:BeingDebugged-flag.exe BeingDebugged-flag.cpp
if errorlevel 1 exit /b 1

echo.
echo Built: %DIR%BeingDebugged-flag.exe
exit /b 0
