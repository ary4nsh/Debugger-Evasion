...
if not defined VCVARS (
    ...
    echo   cl /EHsc /Fe:"KUSER_SHARED_DATA structure.exe" "KUSER_SHARED_DATA structure.cpp"
    exit /b 1
)

call "%VCVARS%" >nul 2>&1

cl /nologo /EHsc /Fe:"KUSER_SHARED_DATA structure.exe" "KUSER_SHARED_DATA structure.cpp"
if errorlevel 1 exit /b 1

echo.
echo Built: %DIR%KUSER_SHARED_DATA structure.exe
exit /b 0
